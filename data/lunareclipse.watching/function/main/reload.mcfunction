...
# Set max_block_modifications (formerly commandModificationBlockLimit) to max so it doesn't interfere with other packs. - This is used for large /fill commands.
